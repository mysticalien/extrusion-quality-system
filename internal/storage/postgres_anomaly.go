...
func NewPostgresAnomalyRepository(pool *pgxpool.Pool) *PostgresAnomalyRepository {
	return &PostgresAnomalyRepository{pool: pool}
}

func (r *PostgresAnomalyRepository) Create(
	ctx context.Context,
...
func (r *PostgresAnomalyRepository) All(ctx context.Context) ([]domain.AnomalyEvent, error) {
	ctx, cancel := context.WithTimeout(ctx, 3*time.Second)
	defer cancel()
...
func (r *PostgresAnomalyRepository) Active(ctx context.Context) ([]domain.AnomalyEvent, error) {
	ctx, cancel := context.WithTimeout(ctx, 3*time.Second)
	defer cancel()
...
func (r *PostgresAnomalyRepository) FindOpenByTypeAndParameter(
	ctx context.Context,
...
func (r *PostgresAnomalyRepository) UpdateOpen(
	ctx context.Context,
	anomaly domain.AnomalyEvent,
) (domain.AnomalyEvent, bool, error) {
	ctx, cancel := context.WithTimeout(ctx, 3*time.Second)
...
func (r *PostgresAnomalyRepository) ResolveOpenByTypeAndParameter(
	ctx context.Context,
	anomalyType domain.AnomalyType,
	parameterType domain.ParameterType,
) (int64, error) {
